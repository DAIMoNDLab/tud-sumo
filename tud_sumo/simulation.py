...
from . import _io, _get_set_funcs, _vehicles, _traffic_signals
...
class Simulation:
    ...
    def load_demand_profiles(self, demand_profiles: str | dict | list | tuple) -> list:
        ...
        _io._load_demand_profiles(self, demand_profiles)
    ...
    def set_tl_metering_rate(self,
        ...
        _traffic_signals._set_tl_metering_rate(self, rm_id, metering_rate, g_time, y_time, min_red,
