...
class Recorder():
    ...
    def save_recording(self, recording_ids: str|list|tuple, video_filename: str|None = None, speed: int|float|None = None, delete_frames: bool = True, delete_view: bool = True, overwrite: bool = True) -> None:
        """
        Saves a recording as a video file.

        Args:
            `recording_ids` (str, list, tuple): ID(s) of the recording(s) to save
        ...
        if not isinstance(recording_ids, (list, tuple)): recording_ids = [recording_ids]
